        ...
        <div className="w-full px-4 sm:px-6 lg:px-8 py-8">
          <div className="flex flex-col md:flex-row gap-8">
            ...
            <aside className="w-full md:w-64 flex-shrink-0 flex flex-col">
              <div className="bg-bg-secondary/70 backdrop-blur-md border border-border-gold/30 rounded-lg p-4 space-y-1 relative shadow-[0_4px_30px_rgba(0,0,0,0.4)] overflow-hidden group hover:border-accent-gold/40 transition-colors duration-300 h-full flex-grow">
                {/* macOS control dots */}
